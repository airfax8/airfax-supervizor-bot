...
module.exports.beta = async(client, message, args) => {
    ...
    if(![config.Yetkili.AbilityYK].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) return message.react(config.Diger.red);
